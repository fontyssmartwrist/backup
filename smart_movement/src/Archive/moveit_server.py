...
class GiveAnglesToROS():
    ...
    def __init__(self):
        ...
        self.real_angles = rospy.Publisher('/current_joint_values', CurrentJointValues, queue_size= 10)
    ...
    def string_to_message(self, res_msg):
        ...
        joint_goal.theta0 = int(res_msg[1:comma1])
        joint_goal.theta1 = int(res_msg[comma1+1:comma2])
        joint_goal.theta2 = int(res_msg[comma2+1:comma3])
        joint_goal.theta3 = int(res_msg[comma3+1:end])
        rospy.loginfo(joint_goal)
        self.real_angles.publish(joint_goal)
