...
class GeneratePathWithMoveIt():
    def __init__(self):
        ...
        #Get the joints value
        s = rospy.Service('joint_status_srv', RequestStatus, self.get_the_joints)
    ...
    def go_to_joint_state(self, theta):      
        ...
        self.joint_goal[4] = theta.data[4]
    ...
    def send_goal(self):
        ...
        if (amount_of_waypoints != 0):
            ...
            last_link_waypoint = self.plan_of_wrist.joint_trajectory.points[amount_of_waypoints-1].positions[4]
            self.send_dynamixel.publish(last_link_waypoint)
            rospy.loginfo("Goal sent to dynamixel")
